...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, disableFocusStyles, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          ...
          {
            "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2": !disableFocusStyles,
          },
          className
        )}
        ref={ref}
