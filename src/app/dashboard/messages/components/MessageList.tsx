...
import { Chat, User } from "@/store/slices/messageSlice";
import { useSearchParams } from 'next/navigation'; 

const getMessageUser = (chatUsers: User[] | undefined, userId: string): User | undefined => {
  ...
  useEffect(() => {
    ...
    if (chatUserId && accessToken) {
      ...
      if (existingChat) {
        ...
        // Handle chat creation or selection logic
        setSelectedChat(null); // Or you might initiate a chat creation API call here
        console.log("No existing chat found, consider creating a new chat.");
      }
    }
  }, [searchParams, chats, accessToken]);
...
const handleSelectChat = (id: string) => {
  ...
  if (chat) {
    console.log("Selected Chat Users:", chat.users); // Debugging line
    setSelectedChat(id);
  }
};
